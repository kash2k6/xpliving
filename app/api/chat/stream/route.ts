...
export async function POST(request: NextRequest) {
  try {
    ...
    const productInstructions = selectedProduct 
      ? `The user has selected ${selectedProduct === 'youth' ? 'Xperience Youth (Liquid Formula)' : 'Roman Xperience'}. Focus your responses on this specific product. Use the knowledge base to provide detailed information about this product. Users can click the "Products" tab to see available products and their prices to purchase.`
