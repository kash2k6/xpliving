...
export default function GrowingStrongBanner() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#0D6B4D] to-[#0b5940] py-2 md:py-3 overflow-hidden">
